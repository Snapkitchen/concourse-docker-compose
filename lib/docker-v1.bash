# with parts from https://github.com/concourse/docker-image-resource/blob/master/assets/common.sh
# licensed under Apache 2.0
# see https://github.com/concourse/docker-image-resource/blob/master/LICENSE
